...
export const PHYSICAL_ACTIVITY_LEVELS = {
  bed_rest:{
    ...
    example: "most of the day is spent sitting, with minimal physical exertion beyond routine activities like walking to the car or doing light household tasks",
    multiplier: 1.2,
  },
  sedentary:{
    name: "Sedentary",
    description: "Some light physical activity beyond their regular daily routine.",
    example: "walking, or light exercise like casual walking or stretching a few days a week",
    multiplier: '1.3-1.4',
  },
  light: {
    name: "Light",
    description: "Moderate-intensity exercise or physical labor.",
    example: "walking, cycling, or light jogging for 30-60 minutes a day, or performing moderate-intensity labor like retail work" ,
    multiplier: 1.6,
  },
  moderate: {
    name: "Moderate",
    description: "Regular hard physical activity which includes more intense exercise or physically demanding jobs.",
    example: "vigorous exercise (running, swimming, high-intensity workouts), manual labor, athletes in training, or those with physically active jobs",
    multiplier: 1.8,
  },
  heavy:{
    name: "Heavy",
    ...
    example: "athletes who train intensively or people doing physically demanding jobs for extended periods",
    multiplier: 2,
  },
};
